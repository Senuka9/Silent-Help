      ...
      appearance={{
        ...
        elements: {
          ...
          socialButtonsBlockButton:
            'bg-white/[0.05] border border-white/[0.1] text-slate-300 hover:bg-white/[0.1] hover:border-white/[0.2] hover:text-white',
          socialButtonsBlockButtonText: 'text-slate-300 font-medium',
          dividerLine: 'bg-white/[0.08]',
          dividerText: 'text-slate-500 uppercase text-xs tracking-wider',
